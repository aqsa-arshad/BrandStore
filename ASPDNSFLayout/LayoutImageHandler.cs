...
{
    public class LayoutImageHandler : IHttpHandler
    {
        ...
        private Guid ImageGuid
        {
            get
            {
                try
                {
                    ...
                    {
                        throw new InvalidOperationException("Layout Image Handler requires a GUID parameter");
                    }
