    ...
    public class ShoppingCartLineItemDescriptionControl : CompositeControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            if (LineItemDescriptionSettings.ShowPicsInCart)
            {
                ...
                {
                    Controls.Add(new LiteralControl("    <div class='row tablet-view'><div class='col-md-4 pull-left-md'><div class='primary-img-box'>"));
                }
            ...
            Controls.Add(new LiteralControl("     <div class='cart-title col-md-7 pull-left-md'> <span class='normal-heading black-color'>"));
