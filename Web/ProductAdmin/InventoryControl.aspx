        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%; border-style: none; padding: 20px;">
            ...
            <tr>
                <td align="left" height="25px" valign="middle">
                    <div class="DisplayOutOfStockGroup">
                        <br />
                        <asp:Label ID="lblRemoveSpace" runat="server" Text="<%$Tokens:StringResource, admin.InventoryControl.Update1 %>" ></asp:Label>
                        <br /><br />
                        <asp:Button ID="btnRemoveSpaces" runat="server" CssClass="normalButtons" Text="<%$Tokens:StringResource, admin.InventoryControl.Update2 %>" OnClick="btnRemoveSpaces_Click" />
                    </div>
                </td>
            </tr>
        </table>
