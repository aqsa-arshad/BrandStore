    ...
    public partial class refundorder : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                writer.Append("<b>FULLY REFUND ORDER: " + ONX.ToString() + "</b><br/><br/>");
                ...
                {
                    writer.Append("<form method=\"POST\" action=\"" + AppLogic.AdminLinkUrl("refundorder.aspx") + "?ordernumber=" + ONX.ToString() + "&confirm=yes\" id=\"RefundOrderForm\" name=\"RefundOrderForm\">");
                    writer.Append("<input type=\"hidden\" name=\"IsSubmit\" value=\"true\">");
                    writer.Append("<p align=\"center\">Are you sure you want to refund this order?<br/><br/></p>");
                    writer.Append("<p align=\"center\">Reason: <input type=\"text\" size=\"50\" maxlength=\"100\" onkeypress=\"javascript:return WebForm_FireDefaultButton(event, 'btnyes')\" name=\"RefundReason\"></p>");
                    writer.Append("<p align=\"center\"><input type=\"submit\" id=\"btnyes\" class=\"normalButtons\" name=\"submit\" value=\"&nbsp;&nbsp;Yes&nbsp;&nbsp;\">");
