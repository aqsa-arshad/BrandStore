        ...
        <div class="modal-dialog modal-checkout" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p runat="server" id="ppointscount">You have XXXXXX BLU&trade; Bucks you can use to purchase items.</p>
                    <p runat="server" id="ppercentage">You can pay for up to XX% of this item's cost with BLU&trade; Bucks.</p>
        ...
        $(document).ready(function () {
            ...
            function setpricewithquantitychange() {
                ...
                if (productfundamount < updatedtotalprice) {
                    ...
                    updatedtotalprice = 0;
                    $("#caBluBuksUsed").text(updatedtotalprice);
                }
