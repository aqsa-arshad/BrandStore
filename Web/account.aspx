				...
				<div class="page-row address-row">
					<div class="one-half address-wrap">
						<asp:Panel ID="pnlBilling" runat="server">
							...
							<div class="address-edit">
								<asp:HyperLink ID="lnkChangeBilling" Text="<%$ Tokens:StringResource,EditAddress %>" runat="server"></asp:HyperLink>
							</div>
					...
					<div class="one-half address-wrap">
						<asp:Panel ID="pnlShipping" runat="server">
							...
							<div class="address-edit">
								<asp:HyperLink ID="lnkChangeShipping" Text="<%$ Tokens:StringResource,EditAddress %>" runat="Server"></asp:HyperLink>
							</div>
							<div class="address-view">
