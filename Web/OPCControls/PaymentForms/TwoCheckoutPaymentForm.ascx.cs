...
[PaymentType(Vortx.OnePageCheckout.Models.PaymentType.TwoCheckout)]
public partial class OPCControls_PaymentForms_TwoCheckoutPaymentForm :
    ...
    IPaymentMethodView
{
	...
	{
        this.PanelTwoCheckoutInfo.Visible = true;
		this.Visible = true;
	}

	public override void Hide()
	{
        this.PanelTwoCheckoutInfo.Visible = false;
		this.Visible = false;
	}
	...
	{        
        Response.Redirect(((TwoCheckoutPaymentModel)this.Model).TwoCheckoutNavigationUrl);
	}
