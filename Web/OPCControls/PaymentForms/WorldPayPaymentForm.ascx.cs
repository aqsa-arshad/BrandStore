...
[PaymentType(Vortx.OnePageCheckout.Models.PaymentType.WorldPay)]
public partial class OPCControls_PaymentForms_WorldPayPaymentForm :
    ...
    IPaymentMethodView
{
	...
	{
        this.PanelWorldPayInfo.Visible = true;
		this.Visible = true;
	}

	public override void Hide()
	{
        this.PanelWorldPayInfo.Visible = false;
		this.Visible = false;
	}
	...
	{        
        Response.Redirect(((WorldPayPaymentModel)this.Model).WorldPayNavigationUrl);
	}
