...
<div class="checkout-head">
    ...
    <ul>
        ...
        <li ID="liShipping" runat="server">
            <asp:HyperLink ID="lnkShipping" NavigateUrl="~/checkoutshipping.aspx?fillcontrols=true" runat="server" Text='<%$ Tokens:StringResource,Checkout.Progress.Shipping %>'></asp:HyperLink>
        </li>
