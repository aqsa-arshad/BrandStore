...
{
	/// <summary>
	/// Summary Spec for ProductSpecFile: class finder for product Spec Spec files (i.e. /descriptions/productspecs/...*.htm) with locale support
	/// </summary>
	public class ProductSpecFile
	{
		...
		public ProductSpecFile(int ProductID)
            : this(ProductID, Localization.GetDefaultLocale(), 1, String.Empty)
		{}

		public ProductSpecFile(int ProductID, String LocaleSetting)
            : this(ProductID, LocaleSetting, 1, String.Empty)
		{}

		public ProductSpecFile(int ProductID, int SkinID)
            : this(ProductID, Localization.GetDefaultLocale(), SkinID, String.Empty)
		{}

		public ProductSpecFile(int ProductID, String LocaleSetting, int SkinID)
            : this(ProductID, LocaleSetting, SkinID, String.Empty)
        { }
